...
async def fetch_prices(symbol, out_name, start_date, end_date):
...
def combine_file(folder_path):
    ...
    big_df.to_csv(os.path.join('/Users/hieppx/Documents/Workspace/MICE3/StockPrediction/datasets/lastest_combined_file.csv'), index=False)

async def async_fetch_data():
    STOCK_DIR = "/Users/hieppx/Documents/Workspace/MICE3/StockPrediction/datasets/HOSE_datasets"
    VN_LIST_PATH = "/Users/hieppx/Documents/Workspace/MICE3/StockPrediction/datasets/VN_HOSE_Companies.csv"
    ...
    df_hose, symbols = await _load_symbols(VN_LIST_PATH)

    print("==================== start fetch data ====================")
    for idx, sym in enumerate(symbols):
        out_name = os.path.join(STOCK_DIR, sym + ".csv")

        succeeded = await fetch_prices(sym, out_name, start_date, end_date)
